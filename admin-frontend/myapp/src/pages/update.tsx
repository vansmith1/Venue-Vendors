...
export default function Create() {
    ...
    useEffect(() => {
        ...
        venueService.getAllVenues().then((venues) => {
            ...
            setVendorId(String(venue.vendorId));
                ...
                <Flex align="flex-start" justify={"space-between"} px={12} py={10} gap={10}>
                    <Box w="50%" minH="450px" mt={6} mb={6} p={10} bg="white" borderRadius="xl" boxShadow="sm" border="1px" borderColor="gray.200">
                        ...
                        <Box textAlign="left">
                            ...
                            <Button bg="#7A5C43" colorScheme="blackAlpha" mt={7} width={293} onClick={updateVenue}>
                                Update Venue
                            </Button>
                        </Box>
                    </Box>
